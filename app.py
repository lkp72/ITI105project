...
Measles = st.number_input("Measles cases", min_value=0.0, max_value=100.0, step=1, format='%.2f', value=100.0)
...
Incidents_HIV = st.number_input("Incidents of HIV", min_value=0.0, max_value=100.0, step=1, format='%.2f', value=0.0)
